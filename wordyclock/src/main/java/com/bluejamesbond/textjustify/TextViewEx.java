package com.bluejamesbond.textjustify;
...
{       
    ...
    { 
        ...
        for(int i = 0; i < blocks.length && lines <= maxLines; i++)
        {
            ...
            wrappedObj = com.bluejamesbond.textjustify.TextJustifyUtils.createWrappedLine(block, paint, spaceOffset, dirtyRegionWidth);
